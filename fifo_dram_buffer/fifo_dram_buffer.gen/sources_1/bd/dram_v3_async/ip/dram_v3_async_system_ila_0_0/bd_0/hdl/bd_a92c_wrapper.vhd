...
----------------------------------------------------------------------------------
--Command: generate_target bd_a92c_wrapper.bd
--Design : bd_a92c_wrapper
...
architecture STRUCTURE of bd_a92c_wrapper is
  component bd_a92c is
  port (
    clk : in STD_LOGIC;
    probe0 : in STD_LOGIC_VECTOR ( 33 downto 0 );
    probe1 : in STD_LOGIC_VECTOR ( 33 downto 0 );
  ...
  end component bd_a92c;
begin
bd_a92c_i: component bd_a92c
     port map (
