...
set_property -dict { PACKAGE_PIN M15   IOSTANDARD LVCMOS33 } [get_ports { ld1 }]; #IO_L23N_T3_35 Sch=led[1]
set_property -dict { PACKAGE_PIN G14   IOSTANDARD LVCMOS33 } [get_ports { ld2 }]; #IO_0_35 Sch=led[2]
set_property -dict { PACKAGE_PIN D18   IOSTANDARD LVCMOS33 } [get_ports { ld3 }]; #IO_L3N_T0_DQS_AD1N_35 Sch=led[3]
