...
----------------------------------------------------------------------------------
--Command: generate_target bd_e813.bd
--Design : bd_e813
...
entity bd_e813 is
  ...
  attribute CORE_GENERATION_INFO of bd_e813 : entity is "bd_e813,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_e813,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=7,numReposBlks=7,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of bd_e813 : entity is "dual_delay_system_ila_0_0.hwdef";
end bd_e813;

architecture STRUCTURE of bd_e813 is
  component bd_e813_ila_lib_0 is
  port (
    clk : in STD_LOGIC;
    probe0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    probe1 : in STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  end component bd_e813_ila_lib_0;
  component bd_e813_g_inst_0 is
  port (
    aclk : in STD_LOGIC;
  ...
  end component bd_e813_g_inst_0;
  component bd_e813_slot_0_aw_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_e813_slot_0_aw_0;
  component bd_e813_slot_0_w_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  end component bd_e813_slot_0_w_0;
  component bd_e813_slot_0_b_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_e813_slot_0_b_0;
  component bd_e813_slot_0_ar_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_e813_slot_0_ar_0;
  component bd_e813_slot_0_r_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In2 : in STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  end component bd_e813_slot_0_r_0;
...
begin
  ...
  resetn_1 <= resetn;
g_inst: component bd_e813_g_inst_0
     port map (
      aclk => clk_1,
      aresetn => resetn_1,
...
ila_lib: component bd_e813_ila_lib_0
     port map (
      clk => clk_1,
      probe0(0) => probe0_1(0),
      probe1(0) => probe1_1(0),
      ...
      probe32(1 downto 0) => net_slot_0_axi_ar_cnt(1 downto 0),
      probe33(31 downto 0) => net_slot_0_axi_araddr(31 downto 0),
      probe34(1 downto 0) => net_slot_0_axi_arburst(1 downto 0),
      probe35(3 downto 0) => net_slot_0_axi_arcache(3 downto 0),
      probe36(7 downto 0) => net_slot_0_axi_arlen(7 downto 0),
      probe37(2 downto 0) => net_slot_0_axi_arprot(2 downto 0),
      probe38(2 downto 0) => net_slot_0_axi_arsize(2 downto 0),
      probe39(1 downto 0) => net_slot_0_axi_aw_cnt(1 downto 0),
      probe4(33 downto 0) => probe4_1(33 downto 0),
      probe40(31 downto 0) => net_slot_0_axi_awaddr(31 downto 0),
      probe41(1 downto 0) => net_slot_0_axi_awburst(1 downto 0),
      probe42(3 downto 0) => net_slot_0_axi_awcache(3 downto 0),
      probe43(7 downto 0) => net_slot_0_axi_awlen(7 downto 0),
      probe44(2 downto 0) => net_slot_0_axi_awprot(2 downto 0),
      probe45(2 downto 0) => net_slot_0_axi_awsize(2 downto 0),
      probe46(1 downto 0) => net_slot_0_axi_b_cnt(1 downto 0),
      probe47(1 downto 0) => net_slot_0_axi_bresp(1 downto 0),
      probe48(1 downto 0) => net_slot_0_axi_r_cnt(1 downto 0),
      probe49(31 downto 0) => net_slot_0_axi_rdata(31 downto 0),
      probe5(0) => probe5_1(0),
      probe50(1 downto 0) => net_slot_0_axi_rresp(1 downto 0),
      probe51(31 downto 0) => net_slot_0_axi_wdata(31 downto 0),
      probe52(3 downto 0) => net_slot_0_axi_wstrb(3 downto 0),
      probe53(1 downto 0) => net_slot_0_axi_aw_ctrl(1 downto 0),
      probe54(2 downto 0) => net_slot_0_axi_w_ctrl(2 downto 0),
      probe55(1 downto 0) => net_slot_0_axi_b_ctrl(1 downto 0),
      probe56(1 downto 0) => net_slot_0_axi_ar_ctrl(1 downto 0),
      probe57(2 downto 0) => net_slot_0_axi_r_ctrl(2 downto 0),
      probe6(0) => probe6_1(0),
      probe7(33 downto 0) => probe7_1(33 downto 0),
      probe8(12 downto 0) => probe8_1(12 downto 0),
      probe9(12 downto 0) => probe9_1(12 downto 0)
    );
slot_0_ar: component bd_e813_slot_0_ar_0
     port map (
      In0(0) => net_slot_0_axi_arvalid,
      In1(0) => net_slot_0_axi_arready,
      dout(1 downto 0) => net_slot_0_axi_ar_ctrl(1 downto 0)
    );
slot_0_aw: component bd_e813_slot_0_aw_0
     port map (
      In0(0) => net_slot_0_axi_awvalid,
      In1(0) => net_slot_0_axi_awready,
      dout(1 downto 0) => net_slot_0_axi_aw_ctrl(1 downto 0)
    );
slot_0_b: component bd_e813_slot_0_b_0
     port map (
      In0(0) => net_slot_0_axi_bvalid,
      In1(0) => net_slot_0_axi_bready,
      dout(1 downto 0) => net_slot_0_axi_b_ctrl(1 downto 0)
    );
slot_0_r: component bd_e813_slot_0_r_0
     port map (
...
slot_0_w: component bd_e813_slot_0_w_0
     port map (
