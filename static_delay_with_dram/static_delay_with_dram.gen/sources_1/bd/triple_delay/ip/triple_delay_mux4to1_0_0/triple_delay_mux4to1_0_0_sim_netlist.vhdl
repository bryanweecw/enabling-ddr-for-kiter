...
-- Command     : write_vhdl -force -mode funcsim -rename_top triple_delay_mux4to1_0_0 -prefix
--               triple_delay_mux4to1_0_0_ dual_delay_mux4to1_0_0_sim_netlist.vhdl
...
entity triple_delay_mux4to1_0_0_mux4to1 is
  port (
...
end triple_delay_mux4to1_0_0_mux4to1;

architecture STRUCTURE of triple_delay_mux4to1_0_0_mux4to1 is
...
entity triple_delay_mux4to1_0_0 is
  ...
  attribute NotValidForBitStream of triple_delay_mux4to1_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of triple_delay_mux4to1_0_0 : entity is "dual_delay_mux4to1_0_0,mux4to1,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of triple_delay_mux4to1_0_0 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of triple_delay_mux4to1_0_0 : entity is "module_ref";
  attribute x_core_info : string;
  attribute x_core_info of triple_delay_mux4to1_0_0 : entity is "mux4to1,Vivado 2022.2";
end triple_delay_mux4to1_0_0;

architecture STRUCTURE of triple_delay_mux4to1_0_0 is
...
begin
U0: entity work.triple_delay_mux4to1_0_0_mux4to1
     port map (
      btn1 => btn1,
      btn2 => btn2,
      btn3 => btn3,
