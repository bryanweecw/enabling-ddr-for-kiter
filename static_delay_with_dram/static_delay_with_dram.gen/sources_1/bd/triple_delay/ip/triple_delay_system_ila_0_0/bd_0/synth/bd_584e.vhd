...
----------------------------------------------------------------------------------
--Command: generate_target bd_584e.bd
--Design : bd_584e
...
entity bd_584e is
  ...
  attribute CORE_GENERATION_INFO of bd_584e : entity is "bd_584e,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_584e,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=7,numReposBlks=7,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of bd_584e : entity is "triple_delay_system_ila_0_0.hwdef";
end bd_584e;

architecture STRUCTURE of bd_584e is
  component bd_584e_ila_lib_0 is
  port (
    clk : in STD_LOGIC;
    probe0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    probe1 : in STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  end component bd_584e_ila_lib_0;
  component bd_584e_g_inst_0 is
  port (
    aclk : in STD_LOGIC;
  ...
  end component bd_584e_g_inst_0;
  component bd_584e_slot_0_aw_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_584e_slot_0_aw_0;
  component bd_584e_slot_0_w_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  end component bd_584e_slot_0_w_0;
  component bd_584e_slot_0_b_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_584e_slot_0_b_0;
  component bd_584e_slot_0_ar_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    dout : out STD_LOGIC_VECTOR ( 1 downto 0 )
  );
  end component bd_584e_slot_0_ar_0;
  component bd_584e_slot_0_r_0 is
  port (
    In0 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In1 : in STD_LOGIC_VECTOR ( 0 to 0 );
    In2 : in STD_LOGIC_VECTOR ( 0 to 0 );
  ...
  end component bd_584e_slot_0_r_0;
  ...
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME CLK.CLK, ASSOCIATED_BUSIF SLOT_0_AXI, ASSOCIATED_RESET resetn, CLK_DOMAIN /clk_wiz_0_clk_out1, FREQ_HZ 50347222, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0";
...
begin
  ...
  resetn_1 <= resetn;
g_inst: component bd_584e_g_inst_0
     port map (
      aclk => clk_1,
      aresetn => resetn_1,
...
ila_lib: component bd_584e_ila_lib_0
     port map (
      clk => clk_1,
      probe0(0) => probe0_1(0),
      probe1(0) => probe1_1(0),
      ...
      probe44(1 downto 0) => net_slot_0_axi_ar_cnt(1 downto 0),
      probe45(31 downto 0) => net_slot_0_axi_araddr(31 downto 0),
      probe46(1 downto 0) => net_slot_0_axi_arburst(1 downto 0),
      probe47(3 downto 0) => net_slot_0_axi_arcache(3 downto 0),
      probe48(7 downto 0) => net_slot_0_axi_arlen(7 downto 0),
      probe49(2 downto 0) => net_slot_0_axi_arprot(2 downto 0),
      probe5(0) => probe5_1(0),
      probe50(2 downto 0) => net_slot_0_axi_arsize(2 downto 0),
      probe51(1 downto 0) => net_slot_0_axi_aw_cnt(1 downto 0),
      probe52(31 downto 0) => net_slot_0_axi_awaddr(31 downto 0),
      probe53(1 downto 0) => net_slot_0_axi_awburst(1 downto 0),
      probe54(3 downto 0) => net_slot_0_axi_awcache(3 downto 0),
      probe55(7 downto 0) => net_slot_0_axi_awlen(7 downto 0),
      probe56(2 downto 0) => net_slot_0_axi_awprot(2 downto 0),
      probe57(2 downto 0) => net_slot_0_axi_awsize(2 downto 0),
      probe58(1 downto 0) => net_slot_0_axi_b_cnt(1 downto 0),
      probe59(1 downto 0) => net_slot_0_axi_bresp(1 downto 0),
      probe6(0) => probe6_1(0),
      probe60(1 downto 0) => net_slot_0_axi_r_cnt(1 downto 0),
      probe61(31 downto 0) => net_slot_0_axi_rdata(31 downto 0),
      probe62(1 downto 0) => net_slot_0_axi_rresp(1 downto 0),
      probe63(31 downto 0) => net_slot_0_axi_wdata(31 downto 0),
      probe64(3 downto 0) => net_slot_0_axi_wstrb(3 downto 0),
      probe65(1 downto 0) => net_slot_0_axi_aw_ctrl(1 downto 0),
      probe66(2 downto 0) => net_slot_0_axi_w_ctrl(2 downto 0),
      probe67(1 downto 0) => net_slot_0_axi_b_ctrl(1 downto 0),
      probe68(1 downto 0) => net_slot_0_axi_ar_ctrl(1 downto 0),
      probe69(2 downto 0) => net_slot_0_axi_r_ctrl(2 downto 0),
      probe7(33 downto 0) => probe7_1(33 downto 0),
      probe8(12 downto 0) => probe8_1(12 downto 0),
      probe9(12 downto 0) => probe9_1(12 downto 0)
    );
slot_0_ar: component bd_584e_slot_0_ar_0
     port map (
      In0(0) => net_slot_0_axi_arvalid,
      In1(0) => net_slot_0_axi_arready,
      dout(1 downto 0) => net_slot_0_axi_ar_ctrl(1 downto 0)
    );
slot_0_aw: component bd_584e_slot_0_aw_0
     port map (
      In0(0) => net_slot_0_axi_awvalid,
      In1(0) => net_slot_0_axi_awready,
      dout(1 downto 0) => net_slot_0_axi_aw_ctrl(1 downto 0)
    );
slot_0_b: component bd_584e_slot_0_b_0
     port map (
      In0(0) => net_slot_0_axi_bvalid,
      In1(0) => net_slot_0_axi_bready,
      dout(1 downto 0) => net_slot_0_axi_b_ctrl(1 downto 0)
    );
slot_0_r: component bd_584e_slot_0_r_0
     port map (
...
slot_0_w: component bd_584e_slot_0_w_0
     port map (
