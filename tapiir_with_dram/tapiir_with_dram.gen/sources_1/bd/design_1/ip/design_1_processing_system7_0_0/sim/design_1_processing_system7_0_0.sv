...
//PORTS
      ...
      bit  [31 : 0] S_AXI_HP2_WDATA;
      bit  [3 : 0] S_AXI_HP2_WSTRB;
      ...
      bit  [31 : 0] S_AXI_HP3_WDATA;
      bit  [3 : 0] S_AXI_HP3_WSTRB;
...
//REG DECLARATIONS
      ...
      reg S_AXI_GP1_ARREADY;
      reg S_AXI_GP1_AWREADY;
      reg S_AXI_GP1_BVALID;
      reg S_AXI_GP1_RLAST;
      reg S_AXI_GP1_RVALID;
      reg S_AXI_GP1_WREADY;
      reg [1 : 0] S_AXI_GP1_BRESP;
      reg [1 : 0] S_AXI_GP1_RRESP;
      reg [31 : 0] S_AXI_GP1_RDATA;
      reg [5 : 0] S_AXI_GP1_BID;
      reg [5 : 0] S_AXI_GP1_RID;
...
import "DPI-C" function void ps7_init_s_axi_gp1(input int S_AXI_GP1_AWID_size,input int S_AXI_GP1_AWADDR_size,input int S_AXI_GP1_AWLEN_size,input int S_AXI_GP1_AWSIZE_size,input int S_AXI_GP1_AWBURST_size,input int S_AXI_GP1_AWLOCK_size,input int S_AXI_GP1_AWCACHE_size,input int S_AXI_GP1_AWPROT_size,input int S_AXI_GP1_AWQOS_size,input int S_AXI_GP1_AWVALID_size,input int S_AXI_GP1_AWREADY_size,input int S_AXI_GP1_WID_size,input int S_AXI_GP1_WDATA_size,input int S_AXI_GP1_WSTRB_size,input int S_AXI_GP1_WLAST_size,input int S_AXI_GP1_WVALID_size,input int S_AXI_GP1_WREADY_size,input int S_AXI_GP1_BID_size,input int S_AXI_GP1_BRESP_size,input int S_AXI_GP1_BVALID_size,input int S_AXI_GP1_BREADY_size,input int S_AXI_GP1_ARID_size,input int S_AXI_GP1_ARADDR_size,input int S_AXI_GP1_ARLEN_size,input int S_AXI_GP1_ARSIZE_size,input int S_AXI_GP1_ARBURST_size,input int S_AXI_GP1_ARLOCK_size,input int S_AXI_GP1_ARCACHE_size,input int S_AXI_GP1_ARPROT_size,input int S_AXI_GP1_ARQOS_size,input int S_AXI_GP1_ARVALID_size,input int S_AXI_GP1_ARREADY_size,input int S_AXI_GP1_RID_size,input int S_AXI_GP1_RDATA_size,input int S_AXI_GP1_RRESP_size,input int S_AXI_GP1_RLAST_size,input int S_AXI_GP1_RVALID_size,input int S_AXI_GP1_RREADY_size);
...
import "DPI-C" function void ps7_simulate_single_cycle_S_AXI_GP1_ACLK();
import "DPI-C" function void ps7_set_inputs_s_axi_gp1_S_AXI_GP1_ACLK(
input bit [5 : 0] S_AXI_GP1_AWID,
input bit [31 : 0] S_AXI_GP1_AWADDR,
input bit [3 : 0] S_AXI_GP1_AWLEN,
input bit [2 : 0] S_AXI_GP1_AWSIZE,
input bit [1 : 0] S_AXI_GP1_AWBURST,
input bit [1 : 0] S_AXI_GP1_AWLOCK,
input bit [3 : 0] S_AXI_GP1_AWCACHE,
input bit [2 : 0] S_AXI_GP1_AWPROT,
input bit [3 : 0] S_AXI_GP1_AWQOS,
input bit S_AXI_GP1_AWVALID,
input bit [5 : 0] S_AXI_GP1_WID,
input bit [31 : 0] S_AXI_GP1_WDATA,
input bit [3 : 0] S_AXI_GP1_WSTRB,
input bit S_AXI_GP1_WLAST,
input bit S_AXI_GP1_WVALID,
input bit S_AXI_GP1_BREADY,
input bit [5 : 0] S_AXI_GP1_ARID,
input bit [31 : 0] S_AXI_GP1_ARADDR,
input bit [3 : 0] S_AXI_GP1_ARLEN,
input bit [2 : 0] S_AXI_GP1_ARSIZE,
input bit [1 : 0] S_AXI_GP1_ARBURST,
input bit [1 : 0] S_AXI_GP1_ARLOCK,
input bit [3 : 0] S_AXI_GP1_ARCACHE,
input bit [2 : 0] S_AXI_GP1_ARPROT,
input bit [3 : 0] S_AXI_GP1_ARQOS,
input bit S_AXI_GP1_ARVALID,
input bit S_AXI_GP1_RREADY
);
import "DPI-C" function void ps7_get_outputs_s_axi_gp1_S_AXI_GP1_ACLK(
output bit S_AXI_GP1_AWREADY,
output bit S_AXI_GP1_WREADY,
output bit [5 : 0] S_AXI_GP1_BID,
output bit [1 : 0] S_AXI_GP1_BRESP,
output bit S_AXI_GP1_BVALID,
output bit S_AXI_GP1_ARREADY,
output bit [5 : 0] S_AXI_GP1_RID,
output bit [31 : 0] S_AXI_GP1_RDATA,
output bit [1 : 0] S_AXI_GP1_RRESP,
output bit S_AXI_GP1_RLAST,
output bit S_AXI_GP1_RVALID
);
...
input bit [31 : 0] S_AXI_HP3_WDATA,
input bit [3 : 0] S_AXI_HP3_WSTRB,
...
output bit [31 : 0] S_AXI_HP3_RDATA,
...
//INITIAL BLOCK
  ...
  ps7_init_s_axi_gp1($bits(S_AXI_GP1_AWID),$bits(S_AXI_GP1_AWADDR),$bits(S_AXI_GP1_AWLEN),$bits(S_AXI_GP1_AWSIZE),$bits(S_AXI_GP1_AWBURST),$bits(S_AXI_GP1_AWLOCK),$bits(S_AXI_GP1_AWCACHE),$bits(S_AXI_GP1_AWPROT),$bits(S_AXI_GP1_AWQOS),$bits(S_AXI_GP1_AWVALID),$bits(S_AXI_GP1_AWREADY),$bits(S_AXI_GP1_WID),$bits(S_AXI_GP1_WDATA),$bits(S_AXI_GP1_WSTRB),$bits(S_AXI_GP1_WLAST),$bits(S_AXI_GP1_WVALID),$bits(S_AXI_GP1_WREADY),$bits(S_AXI_GP1_BID),$bits(S_AXI_GP1_BRESP),$bits(S_AXI_GP1_BVALID),$bits(S_AXI_GP1_BREADY),$bits(S_AXI_GP1_ARID),$bits(S_AXI_GP1_ARADDR),$bits(S_AXI_GP1_ARLEN),$bits(S_AXI_GP1_ARSIZE),$bits(S_AXI_GP1_ARBURST),$bits(S_AXI_GP1_ARLOCK),$bits(S_AXI_GP1_ARCACHE),$bits(S_AXI_GP1_ARPROT),$bits(S_AXI_GP1_ARQOS),$bits(S_AXI_GP1_ARVALID),$bits(S_AXI_GP1_ARREADY),$bits(S_AXI_GP1_RID),$bits(S_AXI_GP1_RDATA),$bits(S_AXI_GP1_RRESP),$bits(S_AXI_GP1_RLAST),$bits(S_AXI_GP1_RVALID),$bits(S_AXI_GP1_RREADY));
...
always@(posedge S_AXI_GP1_ACLK)
  begin

   ps7_set_ip_context(ip_name);

   ps7_set_inputs_s_axi_gp1_S_AXI_GP1_ACLK(
    S_AXI_GP1_AWID,
    S_AXI_GP1_AWADDR,
    S_AXI_GP1_AWLEN,
    S_AXI_GP1_AWSIZE,
   ...
   ps7_simulate_single_cycle_S_AXI_GP1_ACLK();

   ps7_get_outputs_s_axi_gp1_S_AXI_GP1_ACLK(
    S_AXI_GP1_AWREADY,
    S_AXI_GP1_WREADY,
    S_AXI_GP1_BID,
    S_AXI_GP1_BRESP,
