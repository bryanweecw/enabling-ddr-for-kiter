...
architecture Behavioral of broadcast_8 is
...
begin
  ...
  begin
    if falling_edge(clk) then
      ...
      if (is_stored_0 = '1' AND (op_out_ready_0='1' AND op_out_ready_1='1' AND op_out_ready_2='1' AND op_out_ready_3='1' AND op_out_ready_4='1' AND op_out_ready_5='1' AND op_out_ready_6='1' AND op_out_ready_7='1')) then
        is_stored_0 <= '0';
        is_in_ready_0 <= '1';
      else
...
op_out_data_6 <= temp_data_0(bit_width-1 downto 0);
op_out_data_7 <= temp_data_0(bit_width-1 downto 0);
...
op_out_valid_6 <= is_stored_0;
op_out_valid_7 <= is_stored_0;
