...
architecture connections of fp_add is
  constant operator_lifespan : integer := 6;
  constant bit_width : integer := 34;
  -- lower-level component declaration;
  component hs_merger is
  ...
  component fp_add_flopoco_f250 is
    port (clk : in std_logic;
...
begin
  ...
  fp_add_implementation : fp_add_flopoco_f250 port map ( clk => clk,
                                                 X => hsm_out_data0,
                                                 Y => hsm_out_data1,
